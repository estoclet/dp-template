...
/**
 * Provides payment in installments with the Systempay payment gateway.
 *
 * @CommercePaymentGateway(
 *   id = "systempay_multi",
 *   label = @Translation("Systempay - Payment in installments"),
 *   display_label = @Translation("Payment by credit card in installments"),
 *   forms = {
 *     "offsite-payment" = "Drupal\commerce_systempay\PluginForm\MultiForm"
 *   },
 *   modes = {
...
class Multi extends Systempay
{
    ...
    public function buildConfigurationForm(array $form, FormStateInterface $form_state)
    {
        ...
        if (Tools::$pluginFeatures['restrictmulti']) {
            $msg = '<p class="systempay-multi-warn">';
