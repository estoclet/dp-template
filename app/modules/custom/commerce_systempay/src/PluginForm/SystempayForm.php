...
class SystempayForm extends PaymentOffsiteForm
{
    ...
    public function buildConfigurationForm(array $form, FormStateInterface $form_state)
    {
        ...
        $request = $this->buildSystempayRequest($form, $form_state);
    ...
    protected function buildSystempayRequest(array $form, FormStateInterface $form_state)
    {
        ...
        $currency = \SystempayApi::findCurrencyByAlphaCode($payment->getAmount()->getCurrencyCode());
        if (! $currency) {
            $msg = "The used currency {$payment->getAmount()->getCurrencyCode()} is not supported. Systempay module cannot be used.";
        ...
        $lang = \SystempayApi::isSupportedLanguage($current_lang) ? $current_lang : $default_lang;
