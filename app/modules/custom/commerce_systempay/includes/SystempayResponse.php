...
if (! class_exists('SystempayResponse', false)) {
    ...
    class SystempayResponse
    {
        ...
        {
            return in_array($this->transStatus, SystempayApi::getSuccessStatuses()) || $this->isPendingPayment();
        }
        ...
        {
            return in_array($this->transStatus, SystempayApi::getPendingStatuses());
        }
        ...
        {
            return in_array($this->transStatus, SystempayApi::getCancelledStatuses());
        }
        ...
        {
            return in_array($this->transStatus, SystempayApi::getToValidateStatuses());
        }
        ...
        public function getOutputForGateway($case = '', $extra_message = '', $original_encoding = 'UTF-8')
        {
            ...
            $encoding = in_array(strtoupper($original_encoding), SystempayApi::$SUPPORTED_ENCODINGS) ?
