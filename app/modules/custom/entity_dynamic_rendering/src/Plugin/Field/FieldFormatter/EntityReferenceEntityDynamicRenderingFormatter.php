 ...
 *
 * @FieldFormatter(
 *   id = "entity_reference_entity_dynamic_rendering",
 ...
 * )
 */
class EntityReferenceEntityDynamicRenderingFormatter extends EntityReferenceFormatterBase implements ContainerFactoryPluginInterface {
