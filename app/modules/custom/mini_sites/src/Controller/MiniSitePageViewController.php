 ...
 */
class MiniSitePageViewController extends ControllerBase implements ContainerInjectionInterface {
   ...
   */
  public function view(MiniSitePageInterface $mini_site_page, $view_mode = 'full') {
    $page = $this->entityTypeManager
      ->getViewBuilder($mini_site_page->getEntityTypeId())
      ->view($mini_site_page, $view_mode);

    $page['#pre_render'][] = [$this, 'buildTitle'];
    $page['#entity_type'] = $mini_site_page->getEntityTypeId();
    $page['#' . $page['#entity_type']] = $mini_site_page;
