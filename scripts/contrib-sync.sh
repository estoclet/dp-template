...
#rsync -avzP --delete --exclude=".git" "${PROJECT_PATH}"/contrib/layout_options "${APP_PATH}"/modules/custom/
...
#rsync -avzP --delete --exclude=".git" "${PROJECT_PATH}"/contrib/ui_patterns "${APP_PATH}"/modules/custom/
#rsync -avzP --delete --exclude=".git" "${PROJECT_PATH}"/contrib/ui_patterns_views_style "${APP_PATH}"/modules/custom/
#rsync -avzP --delete --exclude=".git" "${PROJECT_PATH}"/contrib/ui_skins "${APP_PATH}"/modules/custom/
...
#rsync -avzP --delete --exclude=".git" "${PROJECT_PATH}"/contrib/ui_suite_protocol "${APP_PATH}"/themes/custom/
