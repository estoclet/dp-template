...
do
  ...
  # Create temporary files directory for Drupal paranoia.
  mkdir -p "${PACKAGE_PATH}"/app/sites/"${!FOLDER_NAME}"/files
...
echo -e "${COLOR_LIGHT_GREEN}Rebuild Drupal paranoia for multisites files directory.${COLOR_NC}"
